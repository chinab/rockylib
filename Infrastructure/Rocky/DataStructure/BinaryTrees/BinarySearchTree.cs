...
namespace Rocky.DataStructure
{
    ...
    public class BinarySearchTree<T> : ICollection<T>, IEnumerable<T>
    {
        ...
        private int count;
        private IComparer<T> comparer;    // used to compare node values when percolating down the tree
        #endregion
        ...
        public IEnumerable<T> Postorder
        {
            get
            {
                ...
                // and one of booleans, indicating if the note has been processed or not.
                Stack<BinaryTreeNode<T>> toVisit = new Stack<BinaryTreeNode<T>>(Count);
