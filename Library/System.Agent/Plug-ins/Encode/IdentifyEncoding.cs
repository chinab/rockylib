...
namespace System.Agent.Encode
{
    /// <summary>
    /// 检测字符编码的类
    /// Create By lion www.lionsky.net(lion-a AT sohu.com)
    ...
    public class IdentifyEncoding
    {
        ...
        internal static string[] NiceName = new string[] { "GB2312", "GBK", "HZ", "Big5", "CNS 11643", "ISO 2022CN", "UTF-8", "Unicode", "ASCII", "UNKNOWN" };
        #endregion
        ...
        /// <returns>返回编码类型("GB2312", "GBK", "HZ", "Big5", "CNS 11643", "ISO 2022CN", "UTF-8", "Unicode", "ASCII", "UNKNOWN")</returns>
        /// <example>
        ...
        public virtual string GetEncodingName(Uri testurl)
        {
            ...
            Stream chinesestream = WebRequest.Create(testurl.AbsoluteUri).GetResponse().GetResponseStream();
        ...
        {
            FileStream chinesefile = null;
            sbyte[] rawtext = new sbyte[Directory.Exists(testfile.FullName) ? 0 : testfile.Length];
            try
            {
